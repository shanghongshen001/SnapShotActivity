...
public class JSONHelper {
		...
		try {
	        ...
	        for (Field field : fields) {   
	            try {   
	                ...
	                fieldGetName = haveMethod(methods, fieldGetName);
	 ...
	 * @return true或者false
	 */
	public static String haveMethod(Method[] methods, String fieldMethod) {
		for (Method met : methods) {
			if (fieldMethod.equalsIgnoreCase(met.getName())) {
				return met.getName();
			}
		}
		return null;
    ...
    public static void setFieldValue(Object obj, Map<String, String> valMap) {   
        ...
        for (Field field : fields) {   
            try {     
                ...
                setMetodName = haveMethod(methods, setMetodName);
                if (setMetodName == null) {   
                    continue;   
                }   
